...
[[resources-create-or-update-user]]
This operation will create or update a user.

=== Request Body
include::{snippets}/create-or-update-user/request-fields.adoc[]

=== Request Headers
include::{snippets}/create-or-update-user/request-headers.adoc[]

=== Example request
include::{snippets}/create-or-update-user/http-request.adoc[]

=== Example response
include::{snippets}/create-or-update-user/http-response.adoc[]

== Delete user
[[resources-delete-user]]
This operation will delete an existing user.
...
== Create or update OrgUnit
[[resources-create-or-update-ou]]
This operation will create or update an OrgUnit.

=== Request Body
include::{snippets}/create-or-update-ou/request-fields.adoc[]

=== Request Headers
include::{snippets}/create-or-update-ou/request-headers.adoc[]

=== Example request
include::{snippets}/create-or-update-ou/http-request.adoc[]

=== Example response
include::{snippets}/create-or-update-ou/http-response.adoc[]

== Delete OrgUnit
[[resources-delete-ou]]
This operation will delete an existing OrgUnit.

=== Path Parameters
include::{snippets}/delete-ou/path-parameters.adoc[]

=== Request Headers
include::{snippets}/delete-ou/request-headers.adoc[]

=== Example request
include::{snippets}/delete-ou/http-request.adoc[]

=== Example response
include::{snippets}/delete-ou/http-response.adoc[]

...
BEGIN
  ...
  INSERT INTO history_users (dato, user_uuid, user_ext_uuid, user_name, user_user_id, domain_id, user_active)
  SELECT CURRENT_TIMESTAMP, u.uuid, u.ext_uuid, u.name, u.user_id, u.domain_id, IIF(u.disabled = 1, 0, 1)

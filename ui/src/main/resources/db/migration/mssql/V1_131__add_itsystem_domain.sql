ALTER TABLE it_systems ADD domain_id BIGINT NULL;
...
ALTER TABLE pending_ad_group_operations ADD domain_id BIGINT NOT NULL;
...
ALTER TABLE dirty_ad_groups ADD domain_id BIGINT NOT NULL;

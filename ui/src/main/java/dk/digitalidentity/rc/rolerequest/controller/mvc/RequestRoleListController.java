...
public class RequestRoleListController {
	...
	public String userRoles(final Model model, final @PathVariable("roleGroupId") Long roleGroupId) {
		...
		model.addAttribute("showSingleTableInRequestApproveEnabled", settingsService.isShowSingleTableInRequestApproveEnabled());
		return "requestmodule/fragments/rolegroup_userrole_list :: itSystemUserRoleTable";
	}

	record RoleForUser(long id, long assignmentId, RoleType type, String itSystemName, String name, String description, String assignedThrough) {}

...
public interface RoleGroupDao extends CrudRepository<RoleGroup, Long> {
	...
	List<RoleGroup> findByRequesterPermissionIn(Collection<RequestableBy> requesterPermissions);
	List<RoleGroup> findByApproverPermissionIn(Collection<ApprovableBy> approverPermissions);
}

...
public enum EmailTemplateType {
	...
	ATTESTATION_REQUEST_FOR_ROLE_CHANGE("html.enum.email.message.type.attestation_request_for_role_change", true, false, Arrays.asList(EmailTemplatePlaceholder.ROLE_NAME, EmailTemplatePlaceholder.REQUESTER_PLACEHOLDER, EmailTemplatePlaceholder.ITSYSTEM_PLACEHOLDER)),

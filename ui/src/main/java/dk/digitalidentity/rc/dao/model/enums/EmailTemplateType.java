...
public enum EmailTemplateType {
	...
	ATTESTATION_REMINDER_10_DAYS("html.enum.email.message.type.attestation_reminder_10", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER)),
	ATTESTATION_REMINDER_3_DAYS("html.enum.email.message.type.attestation_reminder_3", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER)),
	...
	ATTESTATION_SENSITIVE_NOTIFICATION("html.enum.email.message.type.attestation_sensitive_notification", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER)),
	ATTESTATION_SENSITIVE_REMINDER_10_DAYS("html.enum.email.message.type.attestation_sensitive_reminder_10", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER)),
	ATTESTATION_SENSITIVE_REMINDER_3_DAYS("html.enum.email.message.type.attestation_sensitive_reminder_3", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER)),
	ATTESTATION_SENSITIVE_REMINDER_THIRDPARTY("html.enum.email.message.type.attestation_sensitive_reminder_thirdparty", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER)),

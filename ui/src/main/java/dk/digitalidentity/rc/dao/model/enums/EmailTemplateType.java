...
public enum EmailTemplateType {
	...
	ATTESTATION_MANAGERDELEGATE_NOTIFICATION("html.enum.email.message.type.managerdelegate.attestation_notification", true, true, Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNITS_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE, EmailTemplatePlaceholder.MANAGERDELEGATE_PLACEHOLDER)),
	ATTESTATION_MANAGERDELEGATE_REMINDER1("html.enum.email.message.type.managerdelegate.attestation_reminder1", true, true, Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNITS_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE, EmailTemplatePlaceholder.MANAGERDELEGATE_PLACEHOLDER)),
	ATTESTATION_MANAGERDELEGATE_REMINDER2("html.enum.email.message.type.managerdelegate.attestation_reminder2", true, true, Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNITS_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE, EmailTemplatePlaceholder.MANAGERDELEGATE_PLACEHOLDER)),
	ATTESTATION_MANAGERDELEGATE_REMINDER3("html.enum.email.message.type.managerdelegate.attestation_reminder3", true, true, Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNITS_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE, EmailTemplatePlaceholder.MANAGERDELEGATE_PLACEHOLDER)),
	ATTESTATION_MANAGERDELEGATE_REMINDER_THIRDPARTY("html.enum.email.message.type.managerdelegate.attestation_reminder_thirdparty", true, true, Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.USER_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE, EmailTemplatePlaceholder.MANAGERDELEGATE_PLACEHOLDER)),

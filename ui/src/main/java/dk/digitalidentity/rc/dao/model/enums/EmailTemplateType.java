...
public enum EmailTemplateType {
	ATTESTATION_NOTIFICATION("html.enum.email.message.type.attestation_notification", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_REMINDER_10_DAYS("html.enum.email.message.type.attestation_reminder_10", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_REMINDER_3_DAYS("html.enum.email.message.type.attestation_reminder_3", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_REMINDER_THIRDPARTY("html.enum.email.message.type.attestation_reminder_thirdparty", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.USER_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_SENSITIVE_NOTIFICATION("html.enum.email.message.type.attestation_sensitive_notification", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_SENSITIVE_REMINDER_10_DAYS("html.enum.email.message.type.attestation_sensitive_reminder_10", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_SENSITIVE_REMINDER_3_DAYS("html.enum.email.message.type.attestation_sensitive_reminder_3", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_SENSITIVE_REMINDER_THIRDPARTY("html.enum.email.message.type.attestation_sensitive_reminder_thirdparty", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ORGUNIT_PLACEHOLDER, EmailTemplatePlaceholder.USER_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_IT_SYSTEM_NOTIFICATION("html.enum.email.message.type.attestation_it_system_notification", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ITSYSTEM_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_IT_SYSTEM_REMINDER_10_DAYS("html.enum.email.message.type.attestation_it_system_reminder_10", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ITSYSTEM_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_IT_SYSTEM_REMINDER_3_DAYS("html.enum.email.message.type.attestation_it_system_reminder_3", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ITSYSTEM_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),
	ATTESTATION_IT_SYSTEM_REMINDER_THIRDPARTY("html.enum.email.message.type.attestation_it_system_reminder_thirdparty", Arrays.asList(EmailTemplatePlaceholder.RECEIVER_PLACEHOLDER, EmailTemplatePlaceholder.ITSYSTEM_PLACEHOLDER, EmailTemplatePlaceholder.SYSTEM_RESPONSIBLE_PLACEHOLDER, EmailTemplatePlaceholder.ATTESTATION_DEADLINE)),

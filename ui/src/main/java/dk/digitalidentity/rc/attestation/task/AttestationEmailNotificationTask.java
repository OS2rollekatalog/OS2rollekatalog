...
//    @Scheduled(fixedDelay = 50000000)
    ...
    private void setTemplateDaysBeforeEventFromDefaults(final EmailTemplate template) {
        final Integer daysBefore = switch (template.getTemplateType()) {
            case ATTESTATION_NOTIFICATION, ATTESTATION_SENSITIVE_NOTIFICATION, ATTESTATION_MANAGERDELEGATE_NOTIFICATION, ATTESTATION_IT_SYSTEM_NOTIFICATION, ATTESTATION_IT_SYSTEM_ASSIGNMENT_NOTIFICATION -> configuration.getAttestation().getNotifyDaysBeforeDeadline();
            case ATTESTATION_REMINDER1, ATTESTATION_SENSITIVE_REMINDER1, ATTESTATION_MANAGERDELEGATE_REMINDER1, ATTESTATION_IT_SYSTEM_REMINDER1, ATTESTATION_IT_SYSTEM_ASSIGNMENT_REMINDER1 -> configuration.getAttestation().getReminder1DaysBeforeDeadline();
            case ATTESTATION_REMINDER2, ATTESTATION_SENSITIVE_REMINDER2, ATTESTATION_MANAGERDELEGATE_REMINDER2, ATTESTATION_IT_SYSTEM_REMINDER2, ATTESTATION_IT_SYSTEM_ASSIGNMENT_REMINDER2 -> configuration.getAttestation().getReminder2DaysBeforeDeadline();
            case ATTESTATION_REMINDER3, ATTESTATION_SENSITIVE_REMINDER3, ATTESTATION_MANAGERDELEGATE_REMINDER3, ATTESTATION_IT_SYSTEM_REMINDER3, ATTESTATION_IT_SYSTEM_ASSIGNMENT_REMINDER3 -> -configuration.getAttestation().getReminder3DaysAfterDeadline();
            case ATTESTATION_REMINDER_THIRDPARTY, ATTESTATION_SENSITIVE_REMINDER_THIRDPARTY, ATTESTATION_MANAGERDELEGATE_REMINDER_THIRDPARTY, ATTESTATION_IT_SYSTEM_REMINDER_THIRDPARTY, ATTESTATION_IT_SYSTEM_ASSIGNMENT_REMINDER_THIRDPARTY -> -configuration.getAttestation().getEscalationReminderDaysAfterDeadline();

...
import dk.digitalidentity.rc.controller.api.v2.RoleAssignmentApiV2;
...
@ControllerAdvice(assignableTypes = {AuditLogApiV2.class, ConstraintApiV2.class, ItSystemApiV2.class, ManagerSubstituteApiV2.class, UserRoleApiV2.class, UserRoleGroupApiV2.class,
        ...
        ManagerSubstituteApi.class, KspCicsApi.class, ItSystemManagedApi.class, ItSystemApi.class, ConstraintApi.class, ReportApiV2.class, RoleAssignmentApiV2.class})

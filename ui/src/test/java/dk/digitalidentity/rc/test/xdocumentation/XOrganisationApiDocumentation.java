	...
	public void zLoadOrganisationV3() throws Exception {
		...
		.andDo(document("load-organisation-v3", preprocessRequest(prettyPrint()),
				requestFields(
					...
					fieldWithPath("users[].disabled").type("Boolean").description("Set to 'true' if this user is disabled in Active Directory").optional(),
